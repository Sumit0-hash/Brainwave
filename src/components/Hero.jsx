  ...
  return (
    ...
    >
      <div className="container relative " ref={parallaxRef}>
        <div className="relative z-1 max-w-[62rem] mx-auto text-center mb-[4rem] md:mb-20 lg:mb lg:mb-[6rem]">
          <h1 className='h1 mb-6'>Explore the possibilities like this of AI Chatting with
          ...
          <Button href="/pricing" className="my-3" white>
            Get Started
          </Button>
        </div>
        <div className="relative max-w-[23rem] mx-auto md:max-w-5xl xl:mb-24">
          <div className="relative z-1 p-0.5 rounded-xl bg-conic-gradient">
            <div className='relative bg-n-8 rounded-[1rem] '>
              ...
              <div className='aspect-[33/40] rounded-b-[0.9rem] overflow-hidden md:aspect-[688/490] lg:aspect-[1000/490] '>
